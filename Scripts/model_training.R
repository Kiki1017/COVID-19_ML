# Training a tree model on the data
# 
# Script is not working currently... Start line ~96
...
#---Training a tree with CARET---------------------------------------------------------------

# set up parallel processing
registerDoParallel(8)
getDoParWorkers()

# Explore training a model

my_model <- train(confirmed_cum ~ .,
                data = training_ready[,8:94],
                method = 'rf',
                # mstop = 100,
                # maxdepth = 10,
                na.action = na.pass,
...
# Train models!
set.seed(222)
model_list <- caretList(data=training_ready,
                        y_train,
...
#--- CARET Training tree ---------------------------------------------------------------------------------
# Jay adding a new section of the script 
